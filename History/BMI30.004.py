...
line1, = ax.plot(x_axis[:num_samples], np.zeros(num_samples), label='Верхняя Антенна')
line2, = ax.plot(x_axis[:num_samples], np.zeros(num_samples), label='Нижняя Антенна')
...
def update_start(val):
    ...
    num_samples_slider.set_val(min(num_samples, max_length))
    update_plot(val)
...
ax_button0 = plt.axes([0.1, 0.9, 0.1, 0.05])
button0 = Button(ax_button0, '0')

ax_button1 = plt.axes([0.2, 0.9, 0.1, 0.05])
button1 = Button(ax_button1, '1')

ax_button2 = plt.axes([0.3, 0.9, 0.1, 0.05])
button2 = Button(ax_button2, '2')

ax_button3 = plt.axes([0.4, 0.9, 0.1, 0.05])
button3 = Button(ax_button3, '3')

ax_button4 = plt.axes([0.5, 0.9, 0.1, 0.05])
...
def switch_graph(label):
    ...
    if label == '0':
        show_plot = False
        button0.ax.set_facecolor(light_green)  # Изменяем цвет на светло-зеленый
        button0.color = light_green
        button0.hovercolor = light_green
        text_box.set_text('0')
        ...
        show_plot = True
        update_needed = True
        button1.ax.set_facecolor(light_green)  # Изменяем цвет на светло-зеленый
        button1.color = light_green
        button1.hovercolor = light_green
        text_box.set_text('Верхняя и нижняя антенны')
        ...
        show_plot = True
        update_needed = True
        button2.ax.set_facecolor(light_green)  # Изменяем цвет на светло-зеленый
        button2.color = light_green
        button2.hovercolor = light_green
        text_box.set_text('Верхняя антенна')
        print(f"Переключение на график {current_oscilloscope}")
        ...
        show_plot = True
        update_needed = True
        button3.ax.set_facecolor(light_green)  # Изменяем цвет на светло-зеленый
        button3.color = light_green
        button3.hovercolor = light_green
        text_box.set_text('Нижняя антенна')
        print(f"Переключение на график {current_oscilloscope}")
        ...
        show_plot = True
        update_needed = True
        button4.ax.set_facecolor(light_green)  # Изменяем цвет на светло-зеленый
        button4.color = light_green
        button4.hovercolor = light_green
        text_box.set_text('Резерв')
        print(f"Переключение на график {current_oscilloscope}")
