...
CHUNK = 3839        # Устанавливаем количество семлов считывания  (46080 расчетное)  32765  (23041 подобрано опытным путем); 3839: 2 периода 200Гц; 
    ...
    while stream.is_active():
        ...
        if len(dataADC1) > CHUNK2:                               # количество данных больше чем одно считывание
            ...
            for i in range(0, CHUNK4):                      # находим начало цикла 12 периодов первому встреченному переходу меньше/больше нуля
                ...
                if  0 < dataADC1[i] < 6000 and dataADC1[i+1] > 6000: 
                    start_adr = i
                    break  
        ...
        print(count_inp_ADC, f't:{timerT:.3f}', f'start:{start_adr:5}', stop_adr, len(dataADC1), dataADC1[start_adr], dataADC1[start_adr + 1])
