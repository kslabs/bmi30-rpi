        ...
        if count_sample != count_start and len(dataADC1) > CHUNK:                               # количество данных больше чем одно считывание
            ...
            if waveform_output_display == 4:                         # отображаем результирующую осциллограмму усредненного сигнала 2-х циклов с компенсированным DC
                ...
                if temp < 10000:
                    ...
                    tau = 10
                dataINP_result1[mark12] = dataINP_result[mark12] - 10000
                dataINP_result1[mark13] = dataINP_result[mark13] + 10000
                dataINP_result1[mark14] = dataINP_result[mark14] - 10000
                dataINP_result1[mark15] = dataINP_result[mark15] + 10000
                dataINP_result1[mark16] = dataINP_result[mark16] - 10000
                dataINP_result1[0] = dataINP_result[0] + 10000
