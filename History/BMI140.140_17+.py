...
CHUNK_out1 = 990               # Количество выводимых на экран семплов: 1920-1 период; 2880-1.5 периода; 3840-2 периода;
...
def callback(in_data, frame_count, time_info, status):
    ...
    if len(dataADC1) > CHUNK2:
        ...
        for i in range(0, CHUNK):
            if dataADC1[i] < 30000 and dataADC1[i+1] > 30000: #and dataADC1[i+65] > 20000):  # and dataADC1[i+35] < 15000):
                flag_synchro = 1
...
trigger_treshold2 =  3000
trigger_treshold3 =  9000
    ...
    while stream.is_active():
        ...
        if start_adr > 9:
            ...
            if waveform_output_display == 1:                         # отображаем осциллограмму сырого входного сигнала
                ...
                dataADC1[start_adr+20] = dataADC1[start_adr+20] - 5000
                dataADC1[start_adr+40] = dataADC1[start_adr+40] - 5000
                dataADC1[start_adr+60] = dataADC1[start_adr+60] - 5000
                dataADC1[start_adr+80] = dataADC1[start_adr+80] - 5000
                dataADC1[start_adr+100] = dataADC1[start_adr+100] - 5000
