...
try:
    ...
    while True:
        ...
        if correlation_based_detection and len(cross_correlation_sum) > 0 and len(antiphase_correlation_sum) > 0:
            ...
            snr, signal_detected = compute_adaptive_correlation_threshold(
            ...
            # Сохраняем значение текущего SNR как нового порога для плавной адаптации
            adaptive_correlation_threshold = snr
