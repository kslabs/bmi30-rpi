...
# Настраиваем GPIO13 через gpiozero
...
try:
    gpio13.on()  # Устанавливаем GPIO13 в 1
    ...
    gpio13.off()  # Устанавливаем GPIO13 в 0
except Exception as e:
    print(f"Ошибка: {e}")
    pwm.stop()
    gpio13.off()  # Устанавливаем GPIO13 в 0 при ошибке
finally:
    pwm.stop()
    gpio13.off()  # Устанавливаем GPIO13 в 0 при завершении
