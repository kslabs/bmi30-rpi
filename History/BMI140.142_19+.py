...
def callback(in_data, frame_count, time_info, status):
    ...
    if len(dataADC1) > CHUNK:
        ...
        for i in range(0, CHUNK):
            if flag_synchro or (dataADC1[i] < 20000 and dataADC1[i+1] > 20000 and dataADC1[i+28] > 20000 and dataADC1[i+35] < 20000):
                flag_synchro = 1
    ...
    dataADC1[:len(data)] = data[:, 1]  # Заполняем правый канал
