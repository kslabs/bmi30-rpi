...
def callback(in_data, frame_count, time_info, status):
    ...
    if len(dataADC1) > CHUNK:
        ...
        for i in range(0, CHUNK):
            ...
            if dataADC1[i] < 30000 and dataADC1[i+1] > 30000 and dataADC1[i+36] < -28000 and dataADC1[i+66] > 28000:
                flag_synchro = 1
                ...
                start_adr = i
                dataADC9, dataADC8, dataADC7, dataADC6, dataADC5, dataADC4, dataADC3 = np.roll([dataADC8, dataADC7,dataADC6, dataADC5, dataADC4, dataADC3, dataADC2], shift=1) 
                shift_amount = CHUNK + (int(i / 1.2) if i > 8 else 1 if i > 4 else 0 if i > 2 else -1)
    ...
    if start_adr < 10 and tau_start_adr == 0:
        ...
        y_indices_n = np.arange(int(len(dataADC) / 1920)) * 1920 + 960
...
pwm1 = HardwarePWM(pwm_channel=3, hz=200.01920042321, chip=2)    # pwm_channel 1: 3-GPIO_18; 2-GPIO_19; 
...
tau3 = 100
tau4 = 1000
trigger_treshold1 =  1000
trigger_treshold2 =  3500
trigger_treshold3 =  11000
    ...
    while running and stream.is_active():
        ...
        if start_adr > 9:
            ...
            if waveform_output_display == 1:                         # отображаем осциллограмму сырого входного сигнала
                ...
                dataADC1[start_adr+36] = dataADC1[start_adr+36] - 5000
                dataADC1[start_adr+116] = dataADC1[start_adr+116] - 5000
                dataADC1[start_adr+66] = dataADC1[start_adr+66] + 5000
                dataADC1[start_adr+360] = dataADC1[start_adr+300] + 5000
