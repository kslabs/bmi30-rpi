...
correlation_threshold = 67500000000000       # Фиксированный порог для разницы корреляций
        ...
        if correlation_based_detection and len(cross_correlation_sum) > 0 and len(antiphase_correlation_sum) > 0:
            ...
            if len(correlation_diff) > correlation_index:
                ...
                if correlation_value > correlation_threshold:
                    ...
                    print(f"Сигнал обнаружен по разнице корреляций! Значение: {correlation_value:.1f}, Порог: {correlation_threshold}")
                else:
                ...
                if debug_output:
                    print(f"Разница корреляций (+45): {correlation_value:.1f} / {correlation_threshold} | BEEP: {'ON' if correlation_value > correlation_threshold else 'OFF'}")
