...
def callback(in_data, frame_count, time_info, status):
    ...
    global start_adr, count_start, data_to_sum_p, data_to_sum_n, start_adress, stop_adress
    flag_synchro = 0
    ADCmax = 0
    ...
    if start_adr < 10:
        ...
        dataADC = np.concatenate((dataADC5, dataADC4, dataADC3, dataADC2, dataADC1))
...
trigger_treshold2 = 5000
trigger_treshold3 = 20000
...
#    p.terminate()
    ...
    while stream.is_active():
        ...
        if 10 > start_adr and count_start != 0 and count_sample != count_start and len(dataADC1) > CHUNK:                               # количество данных больше чем одно считывание
            ...
            if 1==1 and dataINP_max > trigger_treshold2 + (int(count_delay_tag / 100) * 10000):
                flag_det_tag += 1
                marked_tau = ' +'
            else:
