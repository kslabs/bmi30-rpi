...
waveform_output_display = 14     # Разрешение вывода на экран: 0-без вывода; 1-сырого сигнала; 2-сигнала без постоянной; 3-постоянная составляющая сигнала
...
if 1==1:
    ...
    while stream.is_active():
        ...
        if start_adr > 9:
            ...
            data_to_sum_p2 = (data_to_sum_p * 500000) -dataDC_p - np.mean(data_to_sum_p1)
            data_to_sum_n2 = (data_to_sum_n * 500000) -dataDC_n - np.mean(data_to_sum_n1)
            data_to_sum_p1 = ((data_to_sum_p1 + data_to_sum_p2) // 2).astype(int)
            data_to_sum_n1 = ((data_to_sum_n1 + data_to_sum_n2) // 2).astype(int)
