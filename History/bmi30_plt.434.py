    ...
    if show_plot:
        ...
        if current_oscilloscope == 1:
            ...
            try:
                ...
                # Настраиваем параметры графика
                ax.set_title(f'Амплитуда от сдвига фаз - верхняя антенна (макс: {max_amp:.0f} @ {max_shift}, мин: {min_amp:.0f} @ {min_shift})')
            ...
            try:
                ...
                # Настраиваем параметры графика
                ax.set_title(f'Амплитуда от сдвига фаз - нижняя антенна (макс: {max_amp:.0f} @ {max_shift}, мин: {min_amp:.0f} @ {min_shift})')
                ax.set_xlabel('Сдвиг фаз (семплы)')
                ax.set_ylabel('Амплитуда')
                ax.set_xlim(-100, 100)
                ax.set_ylim(0, max_amp*1.4)  # Увеличиваем масштаб для лучшей видимости
