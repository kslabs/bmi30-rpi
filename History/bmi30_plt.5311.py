...
def update_graph(show_plot, update_needed, current_oscilloscope, start_sample, num_samples, 
                ...
                antiphase_correlation_sum=None, correlation_threshold=None, correlation_detection_count=None, correlation_detection_threshold=None): # Добавляем новые параметры
