...
CHUNK_out = 2880               # Количество выводимых на экран семплов: 1920-1 период; 2880-1.5 периода; 3840-2 периода;
...
def callback(in_data, frame_count, time_info, status):
    ...
    if len(dataADC1) > CHUNK2:                               # количество данных больше чем одно считывание
        for i in range(0, CHUNK):
            if dataADC1[i] < 7000 and dataADC1[i+1] > 7000 and dataADC1[i+40] < -5000:
            #if dataADC1[i] < 4000 and dataADC1[i+1] > 4000:
                start_adr = i
                del dataADC1[0:CHUNK + int(i/2)]
                break 
            if i > CHUNK0:
                del dataADC1[0:CHUNK]
                break
        
    #print(start_adr, len(dataADC1))    
    ...
    while stream.is_active():
        ...
        if count_sample != len(dataADC1) and len(dataADC1) > CHUNK:                               # количество данных больше чем одно считывание
            ...
            if waveform_output_display == 1:                         # отображаем осциллограмму сырого входного сигнала
                ...
                dataADC1[start_adr+880] = dataADC1[start_adr+880] + 5000
