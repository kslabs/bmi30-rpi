...
def update_graph(show_plot, update_needed, current_oscilloscope, start_sample, num_samples, 
    ...
    if show_plot:
        ...
        if current_oscilloscope == 1:
            ...
            offset_sum = -3000  # Сдвиг вниз для суммарных сигналов
            offset_ac = 3000    # Сдвиг вверх для отдельных AC компонентов
            ...
            if max_sample_index_P1 >= 0:
                display_diff_sum_P1[max_sample_index_P1] += 1000
            if max_sample_index_L1 >= 0:
                display_diff_sum_L1[max_sample_index_L1] += 1000
