...
stable_phase_threshold = 3      # Порог стабильности фазы (±5 отсчетов)
...
threshold_margin = 1.3         # Множитель для порога (30% запас)
...
THRESHOLD_SAVE_INTERVAL = 60  # Сохраняем каждую минуту
