...
options=(
    "ТЕКУЩАЯ - 2026-04-06 + AUTORESET - Копия рабочей стабильной базы"
    ...
    "DEV - BMI30.200.py (экспериментальная текущая разработка)"
    "Выход"
)
...
select opt in "${options[@]}"; do
    case $REPLY in
        1)
            echo "Запускаю ТЕКУЩУЮ рабочую версию 2026-04-06 + AUTORESET..."
